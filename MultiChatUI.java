...
public class MultiChatUI extends JFrame {
	...
	public MultiChatUI() {
		...
		outLabel.setPreferredSize(new Dimension(480,25));
		...
		// (JScrollPane)
		JScrollPane scrollPane = new JScrollPane(msgOut, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
